...
- Root entrypoint filenames (`AGENTS.md`, `CLAUDE.md`, etc.): symlinks pointing directly to `.ctxpm/AGENTS.md`; created and repaired by `ctxpm install` and kept out of version control via `.gitignore`.
